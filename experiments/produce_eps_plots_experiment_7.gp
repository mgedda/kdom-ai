...
set terminal x11
plot input_dir."/SCORE_DIFFS_UCT_W-TR_T0_5.dat" using 1:2:3 w yerrorbars lt 1 title 'UCT_W-TR (0.5s)', \
	'' using 1:2 w lines lt 1 title '', \
    input_dir."/SCORE_DIFFS_UCT_W-TR_T2_0.dat" using 1:2:3 w yerrorbars lt 2 title 'UCT_W-TR (2.0s)', \
	'' using 1:2 w lines lt 2 title '', \
    input_dir."/SCORE_DIFFS_UCT_W-FG_T0_5.dat" using 1:2:3 w yerrorbars lt 3 title 'UCT_W-FG (0.5s)', \
	'' using 1:2 w lines lt 3 title '', \
    input_dir."/SCORE_DIFFS_UCT_W-FG_T2_0.dat" using 1:2:3 w yerrorbars lt 4 title 'UCT_W-FG (2.0s)', \
...
set output output_dir."/experiment7_score_diffs.eps"
replot
