...
function process_experiment_3(target_path, output_dir)
    ...
    strats{4} = getStratAsCellArray(strat4, strat4_str, opponent_strat_str);
    strats{5} = getStratAsCellArray(strat5, strat5_str, opponent_strat_str);
    ...
    function writePlayoutsToDatFile(strats, output_path, output_file_prefix)
      ...
      for i = 2:3
        ...
        strat_str = strrep(strats{i}{1}, "/", "_");
        filename = [output_path "/" output_file_prefix "PLAYOUTS_" strat_str ".dat"];
