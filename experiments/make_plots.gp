...
set title "Average playouts per second per round (450 games)"
set xlabel "Round"
...
set terminal x11
plot "run_experiment_2.out/PLAYOUTS_MCE-TR_WDL.dat" using 1:2:3 w yerrorbars lt 1 title 'MC-TR/WDL', \
	'' using 1:2 w lines lt 1 title ''

pause -1

set terminal epslatex
set output outputdir."/experiment2_playouts.tex"
replot
