...
#
# usage: $ gnuplot -e "target_path='<path>'; data_files_dir='<dir>'" produce_plots_experiment_7_prel.gp
#
...
if (!exists("data_files_dir")) data_files_dir='data_files_experiment_7_prel'
...
set output output_dir."/experiment7_prel_score_diffs.tex"
replot
