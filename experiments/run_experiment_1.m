...
output_dir = "run_experiment_1.out";
output_file_prefix = "";
...
function writeBranchingFactorsToDatFile(strats, output_dir, output_file_prefix)
  ...
  for i = 1:1
    ...
    filename = [output_dir "/" output_file_prefix "BRANCHING_FACTORS_" strat_str ".dat"];
...
writeBranchingFactorsToDatFile(strats, output_dir, output_file_prefix);
