...
#
#playGames 200 "UCT_TR_C0_0" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
...
#playGames 200 "UCT_TR_C1_0" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_TR_C1_5" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_TR_C2_0" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCT_TR_C0_0" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
...
#playGames 200 "UCT_TR_C1_0" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_TR_C1_5" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_TR_C2_0" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCT_TR_C0_0" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
...
#playGames 200 "UCT_TR_C1_0" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_TR_C1_5" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_TR_C2_0" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCT_FG_C0_0" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
...
#playGames 200 "UCT_FG_C1_0" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_FG_C1_5" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_FG_C2_0" "FULL_GREEDY"   0.1 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCT_FG_C0_0" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
...
#playGames 200 "UCT_FG_C1_0" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_FG_C1_5" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_FG_C2_0" "FULL_GREEDY"   0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCT_FG_C0_0" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
...
#playGames 200 "UCT_FG_C1_0" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_FG_C1_5" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCT_FG_C2_0" "FULL_GREEDY"   0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

playGames 200 "UCT_FG_C0_0" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C0_1" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C0_2" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C0_3" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C0_4" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C0_5" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C0_6" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C1_0" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C1_5" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
playGames 200 "UCT_FG_C2_0" "FULL_GREEDY"   2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#
# b) Find progressive bias constant W.
#

#playGames 200 "UCTW_TR_C0_5_W0_0"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_1"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_2"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_3"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_4"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_5"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_6"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_7"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_8"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_9"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W1_0"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCTW_TR_C0_5_W0_0"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_1"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_2"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_3"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_4"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_5"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_6"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_7"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_8"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_9"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W1_0"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCTW_TR_C0_5_W0_0"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_1"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_2"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_3"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_4"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_5"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_6"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_7"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_8"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W0_9"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_TR_C0_5_W1_0"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCTW_FG_C1_0_W0_0"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_1"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_2"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_3"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_4"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_5"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_6"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_7"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_8"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_9"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W1_0"  "FULL_GREEDY"  0.2 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCTW_FG_C1_0_W0_0"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_1"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_2"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_3"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_4"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_5"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_6"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_7"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_8"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_9"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W1_0"  "FULL_GREEDY"  0.5 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION

#playGames 200 "UCTW_FG_C1_0_W0_0"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_1"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_2"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_3"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_4"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_5"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_6"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_7"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_8"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W0_9"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
#playGames 200 "UCTW_FG_C1_0_W1_0"  "FULL_GREEDY"  2.0 0 $TARGET_DIR $SYSTEM $CPU_SPEED $REVISION
